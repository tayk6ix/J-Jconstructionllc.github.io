...
const Hero = () => {
  return (
    <div className='bg-[url("/StockPhotos/HeroImage.jpeg")] heroLanding heroHeight text-white text-center flex flex-col items-center justify-center gap-4 tablet:mx-[2.5vw] tablet:px-[5vw] tablet:text-left tablet:items-start'>
