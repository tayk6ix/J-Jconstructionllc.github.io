...
const Footer = () => {
  return (
    <footer className='separation-margin overall-padding blueBG flex flex-col py-[5rem] '>
      <section className='flex flex-col gap-[5rem] desktop:flex-row desktop:justify-between'>
        <FooterP1/>
        <FooterMenu/>
      </section>
      <article className='flex flex-col items-center gap-4  finalBorder font_xs font-light mt-[4%] pt-[5%] tablet:flex-row tablet:justify-between'>
